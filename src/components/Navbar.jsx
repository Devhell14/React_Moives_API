...
import Logoweb from "../assets/images/Logoweb.gif"
  ...
  return (
    <>
            ...
            <nav className={`${activemobile ? 'block' : 'hidden'} fixed bg-black/90 md:bg-black h-full w-full md:w-[15rem] z-30 md:block`}>
                ...
                >
                    <Link to="/" className="Logoweb flex flex-col justify-center items-center m-7 gap-2" onClick={() => setActivemobile(!activemobile)}>
                        <img src={Logoweb} alt="Logoweb" className="w-24" />
                        <h1 className="text-gray-400/70 font-bold text-2xl text-center">Movies-API</h1>
                    </Link>
                </motion.div>
